...
import 'package:find_missing_number/find_missing_number.dart' as find_missing_number;

void main(List<String> arguments) {
  print("masukan deret angka: ");
    String input = stdin.readLineSync();
    print(missing_digits(input));
}
//create function to find missing number
